        ...
        <footer className="max-w-screen-2xl px-4 md:px-8 mx-auto">
          <div className="flex flex-col items-center border-t pt-6">
            <nav className="flex flex-wrap justify-center md:justify-start gap-x-4 gap-y-2 md:gap-6 mb-4">
              <a href="/" className="text-gray-500 hover:text-indigo-500 active:text-indigo-600 transition duration-100">Home</a>
              <a href="/about" className="text-gray-500 hover:text-indigo-500 active:text-indigo-600 transition duration-100">About</a>
              <a href="/beer" className="text-gray-500 hover:text-indigo-500 active:text-indigo-600 transition duration-100">Beer</a>
              <a href="/blog" className="text-gray-500 hover:text-indigo-500 active:text-indigo-600 transition duration-100">Blog</a>
              <a href="/shop" className="text-gray-500 hover:text-indigo-500 active:text-indigo-600 transition duration-100">Shop</a>
            </nav>
